        ...
        <div id="chat-container" class="flex-1 overflow-y-auto p-4 space-y-3">
            {#each messages as message, i}
                <div class="flex {message.role === 'ai' ? 'justify-start' : 'justify-end'}">
                    <div class="max-w-xs md:max-w-sm lg:max-w-md px-4 py-2 rounded-2xl text-sm md:text-base whitespace-pre-wrap 
            ...
            {#if isLoading}
                <div class="flex justify-start">
                    <div class="max-w-xs md:max-w-sm lg:max-w-md px-4 py-2 rounded-2xl bg-[#444654] text-white rounded-bl-none flex gap-2 items-center">
